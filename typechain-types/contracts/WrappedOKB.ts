...
export interface WrappedOKBInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface WrappedOKB extends BaseContract {
  connect(runner?: ContractRunner | null): WrappedOKB;
  waitForDeployment(): Promise<this>;

  interface: WrappedOKBInterface;
