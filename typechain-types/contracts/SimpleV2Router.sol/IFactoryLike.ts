...
export interface IFactoryLikeInterface extends Interface {
...
export interface IFactoryLike extends BaseContract {
  connect(runner?: ContractRunner | null): IFactoryLike;
  waitForDeployment(): Promise<this>;

  interface: IFactoryLikeInterface;
