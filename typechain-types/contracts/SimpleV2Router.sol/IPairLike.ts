...
export interface IPairLikeInterface extends Interface {
  getFunction(
    nameOrSignature: "getReserves" | "mint" | "swap" | "token0" | "token1"
  ): FunctionFragment;
...
export interface IPairLike extends BaseContract {
  connect(runner?: ContractRunner | null): IPairLike;
  waitForDeployment(): Promise<this>;

  interface: IPairLikeInterface;
