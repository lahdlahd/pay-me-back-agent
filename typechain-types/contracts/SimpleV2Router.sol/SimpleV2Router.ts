...
export interface SimpleV2RouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addLiquidity"
      | "factory"
...
export interface SimpleV2Router extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleV2Router;
  waitForDeployment(): Promise<this>;

  interface: SimpleV2RouterInterface;
