...
export interface UniswapV2FactoryDeployerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allPairs"
      | "allPairsLength"
...
export interface UniswapV2FactoryDeployer extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapV2FactoryDeployer;
