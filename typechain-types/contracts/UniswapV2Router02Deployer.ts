...
export interface UniswapV2Router02DeployerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface UniswapV2Router02Deployer extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapV2Router02Deployer;
  waitForDeployment(): Promise<this>;

  interface: UniswapV2Router02DeployerInterface;
